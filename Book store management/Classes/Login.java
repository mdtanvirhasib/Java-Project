...
public class Login extends JFrame implements MouseListener,ActionListener
{
	...
	JButton ulog,alog,cna,cont;
	JLabel namel,pass,headlineLabel,ques,img;
	JPasswordField passfild;
	JTextField name;
	Font myfont,font;
	ImageIcon icon;
	JCheckBox box;
	public Login()
	{
		...
		cont.setBounds(1180,685,170,40);
		cont.setFont(font);
		cont.setBackground(new Color(128,160,109));
