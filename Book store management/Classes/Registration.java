...
public class Registration extends JFrame implements ActionListener
{
	...
	JButton singup,clear,logb;
	JLabel label1,namel,email,phone,id,pass,compass,capctha,headlineLabel,gen,img,text;
	JPasswordField passfild,cpass;
	JTextField name,emailt,pho,idt,capt;
	JRadioButton r1,r2;
	ButtonGroup bg1;
	Font myfont,font;
	ImageIcon icon;
